...
window.addEventListener("load", function () {
  ...
  function init() {
    ...
    const viewHeight =
      window.innerHeight -
      headMain.clientHeight -
      headBlock.clientHeight -
      button.clientHeight;
  ...
  ScrollTrigger.saveStyles("#left_slide");
      ...
      gsap.to("#left_slide", {
        scrollTrigger: {
          ...
          start: "top " + document.querySelector("header").clientHeight,
            ...
            "+=" +
            (document.querySelector("#right_col").offsetHeight -
              document.querySelector(".heading").offsetHeight -
              document.querySelector(".slide1_canvas").offsetHeight -
              document.querySelector(".book_button").offsetHeight), //- document.querySelector('#left_slide').offsetHeight
      ...
      scrollTrigger: {
       ...
       // markers: true, // for tests
        ...
        onUpdate: (self) => {
          ...
          document.querySelector(".fly_obj").style.transform =
            "translateY(-50%) scale(" + scale + ")";
        },
        //snap: 1 / (sections.length - 1),
        start: "top 20%",
        end: () => "+=" + (pinFull.offsetWidth - this.window.innerWidth + 500),
      },
    });
  }
